...
function the_top() {
  dw('<div class="votewidget_skin"><ul>');
    ...
    dw('<a style="color:#eee" href="http://thexnews.com/ubuntu-faq.html">Ubuntu FAQ</a>');
    dw('<div class="votescomments">');
    dw('198 голосов');
...
function top_images() {
  var items = Array();
      ...
      post.url='http://thexnews.com/софт-для-ubuntu-версия-2.html';
      post.id='328';
      ...
      post.url='http://thexnews.com/док-удобная-замена-панели-задач.html';
      post.id='371';
      ...
      var post = new Object();
      post.image='http://thexnews.com/uploads/robots.png';
      post.url='http://thexnews.com/плагины-для-firefox-3.html';
      post.id='172';
      ...
      var post = new Object();
      post.image='http://thexnews.com/uploads/yandex-buttons-stats-150x.png';
      post.url='http://thexnews.com/кнопки-соцсетей-от-Яндекса.html';
      post.id='1148';
